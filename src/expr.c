...
/* ------------------------------------------------------------------ */
/* PM_CALL_NODE handler (extracted from codegen_expr)                  */
/* ------------------------------------------------------------------ */
static char *codegen_expr_call(codegen_ctx_t *ctx, pm_call_node_t *call, pm_node_t *node) {
...
char *codegen_expr(codegen_ctx_t *ctx, pm_node_t *node) {
    ...
    case PM_CALL_NODE:
        return codegen_expr_call(ctx, (pm_call_node_t *)node, node);
